...
export default function Navbar({ siteId = "zevtabs" }: { siteId?: string }) {
  ...
  return (
    <>
      ...
      <div
        className={`md:hidden fixed inset-0 top-[60px] z-[999] bg-black/90 backdrop-blur-xl flex flex-col transition-all duration-500 ${
      ...
      >
        <div className="flex flex-col px-8 pt-10 gap-2">
          ...
          <div className="pt-6">
            <button onClick={toggle} className="text-white/40 text-sm font-medium">
