        ...
        >
              ...
              <div className="flex flex-wrap items-center gap-2 pt-1">
                ...
                {activeChoices.map((c) => (
                  <button
                    ...
                    onClick={() => choose(c)}
                    disabled={!ready}
                    className="rounded-full border border-accent-200 bg-white px-3 py-1.5 text-xs font-medium text-neutral-900 shadow-sm hover:border-accent-400 hover:bg-accent-50 disabled:opacity-50"
                  >
                    {c.label}
                  </button>
                ))}
          ...
          <div className="px-3 py-3 border-t border-gray-100 bg-white flex gap-2 shrink-0">
            <input
              ...
              disabled={!ready}
              className="flex-1 bg-gray-50 border border-gray-200 rounded-full px-4 py-2 text-sm text-neutral-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-400 focus:border-transparent transition disabled:opacity-50"
            />
            <button
              type="button"
