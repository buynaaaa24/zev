...
export async function getFooterSections(lang: string = "mn", siteId: string = "zevtabs"): Promise<FooterSections> {
  ...
  return {
    ...
    bottomLeftText: patch.bottomLeftText as string | undefined,
    bottomRightText: (patch.bottomRightText ?? patch.bottomText) as string | undefined,
  };
}
...
const EMPTY_PARKEASE: ParkEaseSections = {
  ...
  pricing: { label: "", title: "", desc: "", mostPopular: "", ctaBtn: "", note: "", quoteBtn: "", quoteLink: "", tiers: [] },
